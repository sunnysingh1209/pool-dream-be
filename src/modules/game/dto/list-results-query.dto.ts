...
export class ListResultsQueryDto extends PaginationQueryDto {
  @ApiPropertyOptional({ description: 'Search by winner name or email (partial match), minimum 4 characters' })
  @IsOptional()
  @IsString()
  @MinLength(4)
  @MaxLength(255)
  ...
  @ApiPropertyOptional({ enum: GameSubType, description: 'Market filter', example: GameSubType.DELHI_BAZAR })
  @IsOptional()
  @IsEnum(GameSubType)
